...
mixin _$RecordController on RecordControllerBase, Store {
  late final _$stateAtom = Atom(
    name: 'RecordControllerBase.state',
    context: context,
  );
  ...
  late final _$getAllRecordsAsyncAction = AsyncAction(
    'RecordControllerBase.getAllRecords',
    context: context,
  );
  ...
  Future<dynamic> getFiveRecordsByGroup() {
    return _$getFiveRecordsByGroupAsyncAction.run(
      () => super.getFiveRecordsByGroup(),
    );
  }

  late final _$deleteRecordAsyncAction = AsyncAction(
    'RecordControllerBase.deleteRecord',
    context: context,
  );

  @override
  Future<dynamic> deleteRecord(Record record) {
  ...
  Future<void> getAllRecordsByGroup(String group) {
    return _$getAllRecordsByGroupAsyncAction.run(
      () => super.getAllRecordsByGroup(group),
    );
  }

  late final _$RecordControllerBaseActionController = ActionController(
    name: 'RecordControllerBase',
    context: context,
  );
